...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
     ...
     * with version reference <b>hiddenapibypass</b>
     * <p>
    ...
    /**
     * Dependency provider for <b>shizukuApi</b> with <b>dev.rikka.shizuku:api</b> coordinates and
     * with version reference <b>shizukuApi</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getShizukuApi() {
        return create("shizukuApi");
    }

    /**
     * Dependency provider for <b>xdl</b> with <b>io.github.hexhacking:xdl</b> coordinates and
     * with version reference <b>xdl</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getXdl() {
        return create("xdl");
    }
    ...
    /**
     * Group of libraries at <b>rikka</b>
     */
    ...
    public static class RikkaLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>refine</b> with <b>dev.rikka.tools.refine:runtime</b> coordinates and
         * with version reference <b>hiddenapi.refine</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        ...
        /**
         * Group of libraries at <b>rikka.hidden</b>
         */
        ...
        /**
         * Group of libraries at <b>rikka.shizuku</b>
         */
    ...
    public static class RikkaHiddenLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>hiddenapi.stub</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class XposedLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>xposedApi</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>accompanistPager</b> with value <b>0.30.0</b>
         * <p>
        ...
        /**
         * Version alias <b>hiddenapibypass</b> with value <b>4.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getHiddenapibypass() { return getVersion("hiddenapibypass"); }
        ...
        /**
         * Version alias <b>okhttpBom</b> with value <b>4.12.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>shadowhook</b> with value <b>1.0.10</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>shizukuApi</b> with value <b>12.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getShizukuApi() { return getVersion("shizukuApi"); }

        /**
         * Version alias <b>xdl</b> with value <b>2.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getXdl() { return getVersion("xdl"); }

        /**
         * Version alias <b>xposedApi</b> with value <b>82</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getXposedApi() { return getVersion("xposedApi"); }

        /**
         * Version alias <b>zip4j</b> with value <b>2.9.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Group of versions at <b>versions.hiddenapi</b>
         */
    ...
    public static class HiddenapiVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>hiddenapi.refine</b> with value <b>4.3.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>hiddenapi.stub</b> with value <b>4.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
